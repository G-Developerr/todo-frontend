...
function App() {
    ...
    useEffect(() => {
        fetch("https://todo-backend-opgdp9nld-jim-tzins-projects.vercel.app/api/todos")
            .then((res) => res.json())
    ...
    const toggleTodo = (id) => {
        ...
        fetch(`https://todo-backend-opgdp9nld-jim-tzins-projects.vercel.app/api/todos/${id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
